...
import ExplorerSubTabs from "./Explorer/ExplorerSubTabs";
import VideoCarousel from "./Explorer/VideoCarousel";
import CompanyCarousel from "./Explorer/CompanyCarousel";
import VideoPodium from "./Explorer/VideoPodium";
import VideoMosaic from "./Explorer/VideoMosaic";
import CampaignInfoModal from "./Explorer/CampaignInfoModal";
import ExplorerIntroModal from "./Explorer/ExplorerIntroModal";
import ExplorerSearchBar from "./Explorer/ExplorerSearchBar";
import { CampaignVideo } from "./Explorer/VideoCard";
import DevControls from "./DevControls";
import VideoPlayerModal from "./Explorer/VideoPlayerModal";
import ExplorerWalletPopup from "./Explorer/ExplorerWalletPopup";
...
export default function ExplorerContent({ hideHeader = false, onVideoPlayingChange }: ExplorerContentProps) {
  ...
  const generateBestCompletionsCampaigns = (): CampaignVideo[] => {
    ...
    const campaignsToGenerate = Math.min(devPodiumCount, 5);
    // Company domains for logos
    ...
    for (let campaignIndex = 0; campaignIndex < campaignsToGenerate; campaignIndex++) {
      ...
      campaigns.push({
        ...
        startingStory: `This is the initial creation that inspired ${3} amazing completions.`,
        guidelines: 'Must maintain the same theme and quality.',
      });
      ...
      for (let rank = 1; rank <= 3; rank++) {
        campaigns.push({
          ...
          rank: rank,
          completionStory: `This is the winning completion story #${rank}.`,
        });
      }
    }
